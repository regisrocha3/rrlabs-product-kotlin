package io.rrlabs.kotlin.product.configuration;
 ...
 */
@Configuration
@PropertySource(value = "file:./cassandra.properties")
@EnableCassandraRepositories(basePackages = {"io.rrlabs.kotlin.product"})
public class CassandraConfig {
    ...
    public CassandraMappingContext mappingContext() {
    	...
    	try {
			context.setInitialEntitySet(CassandraEntityClassScanner.scan("rr.labs.customer"));
